...
<div class="toolbar">
           ...
           <a href="http://elvis.rowan.edu/~hussai12/Capstone/world_series.php">World Serie>
...
foreach ($data['series'][$seriesLoopNum]['games'] as $game) {
    ...
    $result = $conn->query("SELECT DISTINCT game_year,game_num, home_team, away_team, game_date FROM world_series WHERE game_>
